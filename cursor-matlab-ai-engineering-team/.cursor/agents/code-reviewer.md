...
- No acceptance of unexecuted tests as passed.

## Required Workflow
1. Review requirement-to-change alignment.
2. Review investigation evidence quality.
3. Review implementation scope containment.
4. Review tests and validation claims.
5. Issue findings: blocking/non-blocking with rationale.
